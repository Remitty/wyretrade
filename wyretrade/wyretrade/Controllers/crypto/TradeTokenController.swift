...
class TradeTokenController: UIViewController, UITextFieldDelegate, IndicatorInfoProvider, NVActivityIndicatorViewable {
    ...
    var askAggregatesDay = [TokenTradePrice]()
    var bidAggregatesDay = [TokenTradePrice]()
    var askAggregatesWeek = [TokenTradePrice]()
    var bidAggregatesWeek = [TokenTradePrice]()
    var askAggregatesMonth = [TokenTradePrice]()
    var bidAggregatesMonth = [TokenTradePrice]()
    var askAggregatesAll = [TokenTradePrice]()
    var bidAggregatesAll = [TokenTradePrice]()
